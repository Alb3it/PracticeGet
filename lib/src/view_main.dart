...
class MainView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final PeriodSelectController periodController = PeriodSelectController();
    ...
    void _onPressed(int index) {
      ...
      // print(index);
      // print(periodController.periodSelected);
      // print(periodController.periodList);
    ...
    return Scaffold(
        ...
        body: Center(child: Container(child: Text('asdf')))
